...
public class TrafficUpdatesServer extends TrafficUpdatesImplBase {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		int port = 50051;
		try {
			Server server = ServerBuilder.forPort(port).addService(traffic).build().start();
	...
	public StreamObserver<registration> newUser(StreamObserver<registrationStatus> responseObserver) {
